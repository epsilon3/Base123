...
////////////////////////////////////////////////////////////////////////////////
//
//  Converts an unsigned long int to a string
//         
////////////////////////////////////////////////////////////////////////////////
//
//  [unsigned long int] uliConvert:  unsigned long int to convert
//                                :  returns the string representation of the long
//         
////////////////////////////////////////////////////////////////////////////////

string ConvertUnsignedLongIntToString(unsigned long int uliConvert)
{
	try
	{
		//  Convert
		#ifdef _WIN64
			return to_string(uliConvert);
		#else
			//  String to return
			stringstream ssReturn;
	...
	{
		cout << "ERROR [ConvertUnsignedLongIntToString] Exception Code:  " << ex.what() << "\n";
	}
...
////////////////////////////////////////////////////////////////////////////////
//
//  [unsigned int] untConvert:  integer to convert
//                           :  returns the string representation of the integer
//         
////////////////////////////////////////////////////////////////////////////////

string ConvertUnsignedIntToString(unsigned int untConvert)
{
	try
	{
		try
		...
		{
			cout << "ERROR [ConvertUnsignedIntToString] Exception Code:  " << ex.what() << "\n";
		}
...
//
//  [string] strFilePathName:  file path name to parse
//                          :  returns Base123 structural meta data structure
//         
////////////////////////////////////////////////////////////////////////////////

structMetaStruct GetMetaStructureFromBIGFilePathName(string strFilePathName)
{
	...
	try
	{
		//  File name
		string strFileName;
		//  File name parts vector<string>
		vector<string> vFileNameParts;
		//  ORF parts vector<string>
		...
		{
			//  Get file name
			strFileName = GetFileNameExceptLastExtension(strFilePathName);

			//  Parse file name
			SplitString(strFileName, '.', vFileNameParts);

			//  If file name parts is not empty
			if (vFileNameParts.size() >= 2)
			{
				//  Set accession
				smsGet.strAccession = vFileNameParts[0];
				...
				{
					//  Set frame data
					if (ConvertStringToLowerCase(vORFParts[0]) == "f1")
					{
						smsGet.strFrameDirection = "f";
						smsGet.nFrameNumber = 1;
					}
					else if (ConvertStringToLowerCase(vORFParts[0]) == "f2")
					{
						smsGet.strFrameDirection = "f";
						smsGet.nFrameNumber = 2;
					}
					else if (ConvertStringToLowerCase(vORFParts[0]) == "f3")
					{
						smsGet.strFrameDirection = "f";
						smsGet.nFrameNumber = 3;
					}
					else if (ConvertStringToLowerCase(vORFParts[0]) == "r1")
					{
						smsGet.strFrameDirection = "r";
						smsGet.nFrameNumber = 1;
					}
					else if (ConvertStringToLowerCase(vORFParts[0]) == "r2")
					{
						smsGet.strFrameDirection = "r";
						smsGet.nFrameNumber = 2;
					}
					else if (ConvertStringToLowerCase(vORFParts[0]) == "r3")
					{
						smsGet.strFrameDirection = "r";
						smsGet.nFrameNumber = 3;
					}
					...
					//  Set start
					stringstream(vORFParts[1]) >> smsGet.lStart;

					//  Set stop
					stringstream(vORFParts[2]) >> smsGet.lStop;
				}
			}
		}
		else
		{
			ReportTimeStamp("[GetMetaStructureFromBIGFilePathName]", "ERROR:  File Path Name is Empty");
		}
	}
	catch (exception ex)
	{
		cout << "ERROR [GetMetaStructureFromBIGFilePathName] Exception Code:  " << ex.what() << "\n";
	}
